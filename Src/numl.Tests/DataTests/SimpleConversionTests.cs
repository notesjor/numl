...
namespace numl.Tests.DataTests
{
  ...
  public class SimpleConversionTests
  {
    ...
    public void Test_Univariate_Back_Conversions()
    {
      ...
      Assert.Equal(0.4m, Ject.Convert(0.4d, typeof(decimal))); // decimal
      Assert.Equal(0.1d, Ject.Convert(0.1d, typeof(double))); // double
      Assert.Equal(300f, Ject.Convert(300d, typeof(float))); // single
      Assert.Equal((short) 1, Ject.Convert(1d, typeof(short))); // int16
      Assert.Equal((ushort) 2, Ject.Convert(2d, typeof(ushort))); // uint16
      Assert.Equal(2323432, Ject.Convert(2323432, typeof(int))); // int32
      Assert.Equal((uint) 2323432, Ject.Convert(2323432d, typeof(uint))); // uint32
      Assert.Equal(1232323434345, Ject.Convert(1232323434345d, typeof(long))); // int64
      Assert.Equal((ulong) 1232323434345, Ject.Convert(1232323434345d, typeof(ulong))); // uint64
      Assert.Equal(1232323434345, Ject.Convert(1232323434345d, typeof(long))); // long
    ...
    public void Test_Univariate_Conversions()
    {
      ...
      Assert.Equal(0.4d, Ject.Convert(0.4m)); // decimal
      Assert.Equal(0.1d, Ject.Convert(0.1d)); // double
      Assert.Equal(300d, Ject.Convert(300f)); // single
      Assert.Equal(1d, Ject.Convert((short) 1)); // int16
      Assert.Equal(2d, Ject.Convert((ushort) 2)); // uint16
      Assert.Equal(2323432, Ject.Convert(2323432)); // int32
      Assert.Equal(2323432d, Ject.Convert((uint) 2323432)); // uint32
      Assert.Equal(1232323434345d, Ject.Convert(1232323434345)); // int64
      Assert.Equal(1232323434345d, Ject.Convert((ulong) 1232323434345)); // uint64
      Assert.Equal(1232323434345d, Ject.Convert(1232323434345)); // long
