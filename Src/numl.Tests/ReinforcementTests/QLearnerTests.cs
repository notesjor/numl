...
namespace numl.Tests.ReinforcementTests
{
  ...
  public class QLearnerTests
  {
    ...
    public void Test_QLearning_Path_Finder()
    {
      ...
      Reinforcement.QLearning.QLearnerModel model =
        (Reinforcement.QLearning.QLearnerModel)
        generator.Generate(examples.Item1, examples.Item2, examples.Item3, examples.Item4);
      ...
      var path = "Start: " + master.Id;
      IMDPState current = master;
      var counter = 0;
