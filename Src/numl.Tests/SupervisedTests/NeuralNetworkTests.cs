...
namespace numl.Tests.SupervisedTests
{
  ...
  {
    [Fact]
    public void House_Tests() { HousePrediction(new NeuralNetworkGenerator()); }

    [Fact]
    public void Iris_Tests() { IrisPrediction(new NeuralNetworkGenerator()); }
    ...
    [Fact]
    public void Tennis_Tests() { TennisPrediction(new NeuralNetworkGenerator()); }
