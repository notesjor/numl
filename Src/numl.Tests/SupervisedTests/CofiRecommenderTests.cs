...
namespace numl.Tests.SupervisedTests
{
  ...
  public class CofiRecommenderTests : BaseSupervised
  {
    ...
    /// </summary>
    private readonly Matrix Theta = new[,]
    {
    ...
    private void CheckCofiGradient(double lambda)
    {
      ...
      Assert.True(CheckNumericalGradient(numericalGrad, grad) < 0.0000000001);
    }
    ...
    public void Test_Cofi_CostFunction()
    {
      ...
      Almost.Equal(39.796d, Math.Round(cost, 3), 0.001);
    ...
    public void Test_Cofi_CostFunction_Regularized()
    {
      ...
      Almost.Equal(55.172, Math.Round(cost, 3), 0.0011);

      CheckCofiGradient(1.5);
    }
    ...
    public void Test_Cofi_Recommender()
    {
      var movies = new[]
      {
        new {ID = 1, Name = "From Dawn til Dusk", Ratings = new[] {4, 0, 3, 4, 4, 5, 4}},
        new {ID = 2, Name = "The Hoarder", Ratings = new[] {0, 1, 5, 0, 0, 1, 0}},
        new {ID = 3, Name = "Cowboys and Cows", Ratings = new[] {2, 0, 3, 4, 4, 5, 4}},
        new {ID = 4, Name = "Small Fry Town", Ratings = new[] {0, 1, 2, 0, 1, 4, 0}},
        new {ID = 5, Name = "The White Knight", Ratings = new[] {4, 0, 3, 0, 4, 5, 3}},
        new {ID = 6, Name = "Love Me Tender", Ratings = new[] {0, 1, 1, 3, 0, 0, 0}},
        new {ID = 7, Name = "Total Groove", Ratings = new[] {0, 1, 5, 3, 0, 1, 0}},
        new {ID = 8, Name = "Action Chase", Ratings = new[] {0, 2, 3, 0, 0, 5, 4}},
        new {ID = 9, Name = "Underneath", Ratings = new[] {0, 4, 0, 0, 0, 5, 0}},
        new {ID = 10, Name = "Time Reinvented", Ratings = new[] {0, 0, 4, 3, 0, 3, 2}}
      };
