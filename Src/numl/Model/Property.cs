...
namespace numl.Model
{
  ...
  public class Property
  {
    ...
    public virtual int Length { get { return 1; } set { } }
    ...
    public virtual object Convert(double val) { return Ject.Convert(val, Type); }
    ...
    /// </returns>
    public virtual IEnumerable<string> GetColumns() { yield return Name; }
    ...
    public override string ToString() { return $"[{Name}, {Start}, {Length}] ({GetType().Name})"; }
  }
}