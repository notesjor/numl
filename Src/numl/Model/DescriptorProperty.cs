...
namespace numl.Model
{
  ...
  public class DescriptorProperty
  {
    ...
    private void AddProperty(Property p)
    {
      ...
      {
        var features = new List<Property>(_descriptor.Features ?? new Property[] {}) {p};
    ...
    {
      AddProperty(_label ? type.GenerateLabel(_name) : type.GenerateFeature(_name));
      return _descriptor;
    }
    ...
    {
      var p = new GuidProperty {Name = _name};
      AddProperty(p);
      return _descriptor;
    }
