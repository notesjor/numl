...
namespace numl.Supervised.NeuralNetwork
{
  ...
  public class NetworkTrainingProperties
  {
    ...
    /// </summary>
    public object this[string name] { get { return _Parameters[name]; } set { _Parameters[name] = value; } }
    ...
    ///   Optional parameters object used when training networks.
    ///   <para>Usage: parameters = new { Obj1, Obj2, Obj3... }</para>
    /// </param>
    /// <returns></returns>
    public static NetworkTrainingProperties Create(
      Network network,
      int examples,
      int features,
      double learningRate,
