...
namespace numl.Math.Kernels
{
  ...
  public class PolyKernel : IKernel
  {
    ...
    public PolyKernel(double dimension) { Dimension = dimension; }

    public PolyKernel() { Dimension = 1; }
    ...
    public double Compute(Vector v1, Vector v2) { return System.Math.Pow(1d + v1.Dot(v2), Dimension); }

    /// <summary>
    ///   Returns False (always) indicating this is a non-linear kernel.
    /// </summary>
    public bool IsLinear { get { return false; } }
