...
namespace numl.Math.LinearAlgebra
{
  ...
  public static class VectorExtensions
  {
    ...
    public static Matrix Reshape(
      this Vector source,
      int dimension,
      VectorType vectorType = VectorType.Col,
      VectorType fillType = VectorType.Row)
    {
    ...
    public static Vector Sqrt(this Vector source)
    {
      ...
      return source.Each(System.Math.Sqrt, true);
    }
    ...
    /// <returns></returns>
    public static Vector ToBinary(
      this Vector v,
      Func<double, bool> fnPredicate,
