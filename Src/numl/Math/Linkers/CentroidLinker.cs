...
namespace numl.Math.Linkers
{
  ...
  public class CentroidLinker : ILinker
  {
    ...
    public CentroidLinker(IDistance metric) { _metric = metric; }
    ...
    public double Distance(IEnumerable<Vector> x, IEnumerable<Vector> y) { return _metric.Compute(x.Mean(), y.Mean()); }
  }
}