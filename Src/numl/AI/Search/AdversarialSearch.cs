...
namespace numl.AI.Search
{
  ...
  /// </summary>
  public abstract class AdversarialSearch<TState, TSuccessor> : SearchBase<TState>
    ...
    where TSuccessor : class, ISuccessor
  {
    ...
    internal bool IsTerminal(Node node) { return node.State.IsTerminal || node.Depth == Depth * 2; }
