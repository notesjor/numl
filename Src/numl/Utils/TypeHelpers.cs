...
namespace numl.Utils
{
  ...
  public static class TypeHelpers
  {
    ...
    {
      if (type == null)
        throw new ArgumentNullException("The supplied type parameter was not specified");
    ...
    /// <summary>
    ///   Returns a value indicating whether the type is an inbuilt runtime value type, i.e. string, number, DateTime,
    ///   timespan.
    /// </summary>
    /// <param name="t"></param>
    ...
    {
      return (excludeTypes == null || !excludeTypes.Contains(t)) &&
             (t == typeof(string) ||
              t == typeof(bool) ||
              t == typeof(char) ||
