...
namespace numl.Serialization.Supervised
{
  ...
  {
    public override bool CanConvert(Type type) { return typeof(DecisionTreeModel).IsAssignableFrom(type); }

    public override object Create() { return new DecisionTreeModel(); }
