...
namespace numl.Serialization.Supervised
{
  ...
  {
    public override bool CanConvert(Type type) { return typeof(LinearRegressionModel).IsAssignableFrom(type); }

    public override object Create() { return new LinearRegressionModel(); }
