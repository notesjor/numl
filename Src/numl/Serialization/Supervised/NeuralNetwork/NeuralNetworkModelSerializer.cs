...
namespace numl.Serialization.Supervised.NeuralNetwork
{
  ...
  {
    public override bool CanConvert(Type type) { return typeof(NeuralNetworkModel).IsAssignableFrom(type); }

    public override object Create() { return new NeuralNetworkModel(); }
