...
namespace numl.Serialization.Supervised
{
  ...
  {
    public override bool CanConvert(Type type) { return typeof(KernelPerceptronModel).IsAssignableFrom(type); }

    public override object Create() { return new KernelPerceptronModel(); }
