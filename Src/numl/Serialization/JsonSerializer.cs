...
namespace numl.Serialization
{
  ...
  public abstract class JsonSerializer : ISerializer
  {
    ...
    public void PostRead(JsonReader reader) { reader.ReadEndObject(); }

    /// <summary>
    ///   Writes closing content.
    /// </summary>
    /// <param name="writer"></param>
    public void PostWrite(JsonWriter writer) { writer.WriteEndObject(); }
  ...
  public abstract class JsonSerializer<T> : JsonSerializer
  {
    ...
    public override object Create() { return Activator.CreateInstance<T>(); }
